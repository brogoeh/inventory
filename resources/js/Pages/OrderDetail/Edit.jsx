...
export default function Edit() {
    const { errors, orders, items, orderDetail } = usePage().props;

    const [formData, setFormData] = useState({
        order_id: orderDetail.order_id,
        item_id: orderDetail.item_id,
        qty_ordered: orderDetail.qty_ordered,
        qty_received: orderDetail.qty_received,
        qty_cancelled: orderDetail.qty_cancelled,
        reason_cancelled: orderDetail.reason_cancelled,
        created_id: orderDetail.created_id,
        received_id: orderDetail.received_id,
        last_receive_dttm: orderDetail.last_receive_dttm,
    });
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        router.post(route("order-detail.update", orderDetail.id), {
            ...formData,
            _method: "PUT",
        });
    };
