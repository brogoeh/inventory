...
export default function Edit() {
    const { errors, submenu, menus, roles } = usePage().props;
    const role_id = submenu.roles[0].role_name;
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        router.post(route("submenu.update", submenu.id), {
            ...formData,
            _method: "put",
        });
    };
                        ...
                        <div className="mb-6">
                            ...
                            >
                                ...
                                <option
                                    value="1"
                                    selected={
                                        submenu.is_active == 1 ? true : false
                                    }
                                >
                                    Active
                                </option>
                                <option
                                    value="0"
                                    selected={
                                        submenu.is_active == 0 ? true : false
                                    }
                                >
                                    Inactive
                                </option>
