...
export default function Edit() {
    const { errors, orderStat } = usePage().props;

    const [formData, setFormData] = useState({
        status_code: orderStat.status_code,
        status_name: orderStat.status_name,
    });
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        router.post(route("order-status.update", orderStat.id), {
            ...formData,
            _method: "PUT",
        });
    };
