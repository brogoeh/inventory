...
export default function Edit({ supplier }) {
    ...
    const [formData, setFormData] = useState({
        ...
        created_id: supplier.created_id,
        updated_id: supplier.updated_id,
    });
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        router.post(route("supplier.update", supplier.id), {
            ...formData,
            _method: "PUT",
        });
    };
